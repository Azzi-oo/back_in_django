...
from soc_net.api.serializers import ChatListSerializer, ChatSerializer, CommentSerializer, MessageListSerializer, MessageSerializer, PostCreateUpdateSerializer, PostListSerializer, PostRetrieveSerializer, ReactionSerializer, UserRegistrationSerializer, UserListSerializer, UserRetrieveSerializer
from soc_net.models import Chat, Comment, Message, Post, User
